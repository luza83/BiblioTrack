...
namespace BiblioTrack.Migrations
{
    ...
    [Migration("20260329155220_AddBookExtraColumns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiblioTrack.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BiblioTrack.Models.BookCopy", b =>
                {
                    b.HasOne("BiblioTrack.Models.Book", "Book")
                        .WithMany()
            ...
            modelBuilder.Entity("BiblioTrack.Models.Borrowings", b =>
                {
                    b.HasOne("BiblioTrack.Models.BookCopy", "Copy")
                        .WithMany()
                        .HasForeignKey("CopyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BiblioTrack.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BiblioTrack.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
